document.addEventListener("DOMContentLoaded", () => {
    ...
    const questionsData = {
        ...
        2: [ // Химическая реакция
            ...
            { points: 10, text: '🔵В честь ученого из какой страны назван пятый химический элемент бор?', answer: 'произошел от "бурак"    ', image: 'img/oxidation.jpg' },

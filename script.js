document.addEventListener("DOMContentLoaded", () => {
    ...
    const questionsData = {
        ...
        1: [ // Биологическое разнообразие
            ...
            { points: 10, text: 'Какое животное ученые используют  для учета количества клещей?', answer: 'ежей', image: 'img/evaporation.jpg' },
            { points: 15, text: '🔵ТАК называется плод у мака, льна и хлопчатника.', answer: 'коробочка', image: 'img/photosynthesis.jpg' },
            { points: 20, text: 'Назовите животное, на пол потомства которого влияет температура?', answer: 'роо', image: 'img/ecosystem.jpg' },
        ],
        2: [ // Химическая реакция
            ...
            { points: 10, text: '🔵В честь ученого из какой страны назван пятый химический элемент бор?', answer: 'никакой, произошел от "бурак"', image: 'img/oxidation.jpg' },
        ...
        4: [ // По морям и океанам
            ...
            { points: 20, text: 'Какой самый продаваемый товар в мире?', answer: 'Кубик Рубика', image: 'img/saturn.jpg' },
        ],
        5: [ // К звездам ввысь
        ...
        6: [ // Коды информатики
            ...
            { points: 20, text: 'Его создателем считается Масахиро Хара. Сам термин является зарегистрированным товарным знаком японской компании «Denso»', answer: 'Quick Response code — код быстрого отклика; сокр. QR code)', image: 'img/oop.jpg' },
        ],
        7: [ // Чёрный ящик
            { points: 5, text: 'В каком году начал функционировать техникум?', answer: '1955', image: 'img/black_box.jpeg' },
            { points: 10, text: 'Вставьте пропущенное число вместо x:\n\nx февраля 1955 года к учёбе в машиностроительном техникуме приступило x учащихся (+-1000ч).', answer: '18000', image: 'img/system.jpeg' },
            { points: 15, text: 'Сколько специальностей в колледже в настоящее время?', answer: '8', image: 'img/feedback.jpeg' },
            { points: 20, text: 'Сколько директоров руководило техникумом и колледжем за 70 лет?', answer: '5', image: 'img/elements.jpeg' },
        ]
    };
